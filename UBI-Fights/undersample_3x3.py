...
args = {"data_folder": "D:\\abnormal_detection_dataset\\UBI_FIGHTS\\videos\\All\\",
        "graphs_folder": "./graph/3x3_same/resnet10/", "epoch": 150, "batch_size": 1, "num_class": 1, "learning_rate": 1e-4,
...
model_save_folder = './trained_model/3x3_same/'
...
class CustomDataset(Dataset):
    def __init__(self, video_files, annotation_files, transform=None, FPS=args["FPS"], img_size=args["img_size"], frame_chunk=9):
